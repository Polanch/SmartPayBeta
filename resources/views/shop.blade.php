                            ...
                            <div class="product-card">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-stock">
                                        ...
                                        @php
                                            $totalStock = $product->TotalPieces - (isset($product->StocksPerUnit) ? $product->StocksPerUnit : 0);
                                            $stockPercentage = $product->TotalPieces > 0 ? ($totalStock / $product->TotalPieces) * 100 : 0;
                                        @endphp
